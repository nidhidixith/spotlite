      ...
      <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
        ...
        <View className="mb-6">
          ...
          <Text className="text-sm text-gray-700 mb-4">
            Sometimes, all we need is a little time off. Instead of deleting
            your account, why not log out for a while? Your account will be here
        ...
        <View className="mb-4">
          ...
          <Text className="text-sm text-gray-700 mb-1">
            Your content: All your posts, events, and comments will be
            permanently deleted.
          </Text>
          <Text className="text-sm text-gray-700 mb-1">
